...
var bar = "optimistic";
var barOne = bar.substring(0,1);
var barTwo = bar.substring(1,10);

console.log(barOne .toUpperCase() + barTwo .toLowerCase());

//Crear una variable de tipo string con al menos 10 caracteres y algún espacio en blanco. Encontrar la posición del primer espacio en blanco y guardarla en una variable (utilizar indexOf).
console.log("Excercise 2-e");

var coffe = "Stabooks Coffe";
var space = coffe.indexOf(" ");

console.log("The position is:" + space);
...
var ch = "challeng accepted";
var chIn = ch.indexOf(" ") +1;
var chOne = ch.substring(0,1).toUpperCase() + ch.substring(1,8).toLowerCase() + " " + ch.substring(chIn,10).toUpperCase() + ch.substring(10,19).toLowerCase();
